...
// +kubebuilder:webhook:path=/mutate-analytics-piersharding-com-v1-dask,mutating=true,failurePolicy=fail,groups=analytics.piersharding.com,resources=dasks,verbs=create;update,versions=v1,name=mdask.piershading.com
...
// +kubebuilder:webhook:verbs=create;update,path=/validate-analytics-piersharding-com-v1-dask,mutating=false,failurePolicy=fail,groups=analytics.piersharding.com,resources=dasks,versions=v1,name=vdask.piershading.com
